...
urlpatterns = [
    ...
    path('roles/update-role/code_role', get_update_role, name="update-role"),
    ...
    path('permissions/update-permission/code_permission', get_update_permission, name="update-permission"),
