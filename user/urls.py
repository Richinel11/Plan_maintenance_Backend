...
from .views import LoginAPIView, LogoutAPIView, EntiteMetierViewSet,create_user, get_users, get_update_user, delete_user, restore_user, get_user_id
...
urlpatterns = [
    ...
    # path('get-user/<str:user_id>/', get_user_id, name='get_user'),
