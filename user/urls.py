...
from .views import LoginAPIView, LogoutAPIView, EntiteMetierViewSet,create_user, get_users,get_update_user, delete_user, restore_user, find_user  
...
urlpatterns = [
    ...
    path('find-user/<uuid:user_id>/',find_user, name='find_user'),
